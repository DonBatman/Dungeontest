...
minetest.register_tool("dungeon_armor:"..mat.."_helmet_"..col, {
		description = mdes.." Helmet Enchanted "..des,
		inventory_image = "dungeon_armor_inv_helmet_"..mat.."_"..col..".png",
		groups = {armor_head=ar1, armor_heal=ar2, armor_use=ar3, armor_fire=ar4},
		wear = 0,
})
minetest.register_tool("dungeon_armor:"..mat.."_chestplate_"..col, {
		description = mdes.." Chestplate Enchanted "..des,
		inventory_image = "dungeon_armor_inv_chestplate_"..mat.."_"..col..".png",
		groups = {armor_torso=20, armor_heal=12, armor_use=50, armor_fire=ar4},
		wear = 0,
})
minetest.register_tool("dungeon_armor:"..mat.."_leggings_"..col, {
		description = mdes.." Leggings Enchanted "..des,
		inventory_image = "dungeon_armor_inv_leggings_"..mat.."_"..col..".png",
		groups = {armor_legs=20, armor_heal=12, armor_use=50, armor_fire=ar4},
		wear = 0,
	})
minetest.register_tool("dungeon_armor:"..mat.."_boots_"..col, {
		description = mdes.." Boots Enchanted "..des,
		inventory_image = "dungeon_armor_inv_boots_"..mat.."_"..col..".png",
