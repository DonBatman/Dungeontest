...
minetest.register_node("mechanisms:lever_up", {
	...
	node_box = {
		...
		fixed = {
			...
			{-0.0625, -0.0625, 0.25, 0.0625, 0.0625, 0.375},
			{0.0625, -0.375, -0.125, 0.125, -0.1875, 0.125},
			{-0.125, -0.5, -0.125, -0.0625, -0.1875, 0.125},
		--[[
	...
	on_construct = function(pos)
		...
		if node.param2 == 7 then
			minetest.set_node(pos,{name = "mechanisms:lever_up", param2 = 6})
		elseif node.param2 == 9 then
			minetest.set_node(pos,{name = "mechanisms:lever_up", param2 = 8})
		elseif node.param2 == 12 then
			minetest.set_node(pos,{name = "mechanisms:lever_up", param2 = 15})
		elseif node.param2 == 18 then
			minetest.set_node(pos,{name = "mechanisms:lever_up", param2 = 17})
		end
	end,
	on_rightclick = function(pos, node, player, itemstack, pointed_thing)
		-- If the player is holding the Tome of DungeonMaking, allow setup
...
minetest.register_node("mechanisms:lever_down", {
	...
	node_box = {
		...
		fixed = {
			{-0.3125, -0.5, -0.3125, 0.3125, -0.375, 0.3125},
			{-0.0625, -0.5, -0.0625, 0.0625, -0.25, 0.0625},
			{-0.0625, -0.3125, -0.125, 0.0625, -0.1875, -0},
			{-0.0625, -0.25, -0.1875, 0.0625, -0.125, -0.0625},
			{-0.0625, -0.1875, -0.25, 0.0625, -0.0625, -0.125},
			{-0.0625, -0.125, -0.3125, 0.0625, -0, -0.1875},
			{-0.0625, -0.0625, -0.375, 0.0625, 0.0625, -0.25},
			{-0.125, -0.375, -0.125, -0.0625, -0.1875, 0.125},
			{0.0625, -0.5, -0.125, 0.125, -0.1875, 0.125},
		--[[
			{-0.3125, -0.3125, 0.375, 0.3125, 0.3125, 0.5},
			{-0.0625, -0.0625, 0.25, 0.0625, 0.0625, 0.5},
			{-0.0625, -0.125, 0.1875, 0.0625, -0, 0.3125},
